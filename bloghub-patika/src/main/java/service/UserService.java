...
import util.CreateHashPassword;
...
public class UserService {
    ...
    public User saveUser(String email, String password) throws NoSuchAlgorithmException {
        String hashedPassword= CreateHashPassword.hashPassword(password);


        User user = new User(email, hashedPassword); // ödev password' hash'le
